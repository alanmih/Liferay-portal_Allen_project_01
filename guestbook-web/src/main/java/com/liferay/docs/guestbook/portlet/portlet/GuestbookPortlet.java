...
public class GuestbookPortlet extends MVCPortlet {
	...
	public void addEntry(ActionRequest request, ActionResponse response) throws PortalException{
		...
		//Following codes will cause guestbook-web failed to deploy
		//TODO debug the reason that fail guestbook-web 
...
//						email, phone, address, message, serviceContext);
//
...
//
//			try {
//				_guestbookEntryLocalService.addGuestbookEntry(serviceContext.getUserId(), guestbookId, userName, email, phone, address, message,
//						serviceContext);
//
//				response.setRenderParameter("guestbookId", Long.toString(guestbookId));
//
...
//	   //If there are some source codes in the method, it would fail the guestbook-web deployment  
//	   //TODO reason to be checked
//	   
////        long entryId = ParamUtil.getLong(request, "entryId");
////        long guestbookId = ParamUtil.getLong(request, "guestbookId");
////
...
//	}
//   
   //Following codes will fail guestbook-web deployment also
   //TODO Cause to be checked 
